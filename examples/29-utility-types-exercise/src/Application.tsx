...
type UserModelWithoutAccount = Omit<UserModel, 'accountId'>;
...
const CurrentUser = ({ displayName, isVerified }: UserModelWithoutAccount) => {
  return (
...
type CurrentUserProps = React.ComponentProps<typeof CurrentUser>;
